...
> 主界面：左侧为文档分类与文档列表，右侧为文档编辑器/内容区。

![主界面 - 文档库与文档编辑器](./screenshots/01-main-window.png)
...
![新建草稿对话框](./screenshots/02-new-draft.png)
...
![智能仿写对话框](./screenshots/03-imitate-prd.png)
...
![文档质检 - 角色选择](./screenshots/04-quality-check.png)
...
![AI 图片工具](./screenshots/05-image-tool.png)

![图片库](./screenshots/10-image-library.png)
...
![知识库管理](./screenshots/06-knowledge-base.png)
...
![Excel 表格编辑](./screenshots/07-excel-editor.png)
...
![快捷工具 - SVN 更新与快捷导航](./screenshots/08-tools.png)
...
![设置 - AI 模型配置](./screenshots/09-settings.png)
